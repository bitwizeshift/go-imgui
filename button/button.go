...
func Small(label string) *Button { return &Button{Label: label, Small: true} }
...
func (a *Arrow) Pressed() bool { return a.pressed }
...
func NewProgressBar(fraction float32) *ProgressBar { return &ProgressBar{Fraction: fraction} }
